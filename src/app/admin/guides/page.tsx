          ...
          <form onSubmit={handleSubmit} className="bg-gray-900 p-6 rounded-lg space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-800 border-gray-700 rounded-md mt-1"
                required
              />
            </div>
            <div>
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                className="flex-1 bg-pink-600 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-md"
              >
                {isEditing ? '更新' : '作成'}
              </button>
              {isEditing && (
        ...
        <div className="md:col-span-2">
          <div className="bg-gray-900 p-6 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              {guides.length === 0 && (
                <div className="text-sm text-gray-400">登録されたガイドはありません。</div>
              )}
            </div>
          </div>
        </div>

          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {recentSearches.map((term) => (
                <div
                  key={term}
                  className="flex items-center bg-gray-800 rounded-full hover:bg-gray-700 transition-colors"
                >
                  <button
                  ...
                  <button
                    ...
                    className="pr-2 text-gray-500 hover:text-white transition-colors cursor-pointer"
                  >
                    <X size={14} />
                  </button>
                </div>
              ...
              {popularKeywords.map((keyword, index) => (
                <li key={index}>
                  <button
                    ...
                    className="flex items-center w-full text-left p-1 rounded-md hover:bg-gray-800 transition-colors cursor-pointer"
                  >
                    <span className="font-bold text-pink-500 w-6">
                      {index + 1}
                    </span>
                    <span>{keyword}</span>
                  </button>

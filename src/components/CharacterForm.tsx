    ...
    <>
      ...
      {uploadProgress && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-gray-900/95 backdrop-blur-xl p-8 rounded-xl max-w-md w-full border border-gray-700/50 shadow-2xl selection:bg-blue-500 selection:text-white">

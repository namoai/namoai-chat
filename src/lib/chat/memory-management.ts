...
【重要な注意事項】
- 会話内容が日本語以外の言語（韓国語、英語など）で書かれている場合でも、キーワードは必ず日本語で抽出してください
- 他の言語の単語をそのまま返すのではなく、日本語に翻訳・変換してから返してください
- 例：韓国語の「오디션」→「オーディション」、「콘서트」→「コンサート」
- 例：英語の「concert」→「コンサート」、「audition」→「オーディション」
...
【絶対に除外する単語】
- 代名詞（例：彼、彼女、彼は、彼女は、ユーザー）
- 助詞・助動詞（例：は、が、を、に、の、で、へ、と、から、まで、より）
- 一般的すぎる動詞（例：する、した、ある、あった、いる、いた、なる、なった、見る、見た、言う、言った、思う、思った）
- 一般的すぎる形容詞（例：いい、良い、よい、悪い、大きい、小さい、多い、少ない、新しい、古い）
